...
namespace E6502 {
	...
	static constexpr InstructionHandler LOGIC_INSTRUCTIONS[] = {
		...
		INS_EOR_IMM, INS_EOR_ABS, INS_EOR_ABX, INS_EOR_ABY, INS_EOR_ZP0,

		/** AND Instruction Definitions */
		INS_AND_IMM, INS_AND_ABS, INS_AND_ABX, INS_AND_ABY, INS_AND_ZP0,

		/** ORA Instruction Definitions */
		INS_ORA_IMM, INS_ORA_ABS, INS_ORA_ABX, INS_ORA_ABY, INS_ORA_ZP0,
