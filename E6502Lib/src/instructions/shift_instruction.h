...
namespace E6502 {
	...
	static constexpr InstructionHandler SHIFT_INSTRUCTIONS[] = {
		...
		INS_ASL_ACC, INS_ASL_ABS, INS_ASL_ABX, INS_ASL_ZP0,

		/** ROL Instruction Definitions */
		INS_ROL_ACC, INS_ROL_ABS, INS_ROL_ABX, INS_ROL_ZP0,

		/** LSR Instruction Definitions */
		INS_LSR_ACC, INS_LSR_ABS, INS_LSR_ABX, INS_LSR_ZP0,

		/** ROR Instruction Definitions */
		INS_ROR_ACC, INS_ROR_ABS, INS_ROR_ABX, INS_ROR_ZP0,
	};
}
