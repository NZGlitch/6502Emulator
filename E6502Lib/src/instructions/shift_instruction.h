...
namespace E6502 {
	...
	constexpr static InstructionHandler INS_ASL_ZP0 = { 0x1E, true, "ASL - Arithmetic Shift Left [Zero Page]",	ShiftInstruction::shiftHandler };
	...
	constexpr static InstructionHandler INS_ROL_ZP0 = { 0x3E, true, "ROL - Rotate Left [Zero Page]", ShiftInstruction::shiftHandler };
	...
	constexpr static InstructionHandler INS_LSR_ZP0 = { 0x5E, true, "LSR - Logical Shift Right [Zero Page]", ShiftInstruction::shiftHandler };
	...
	constexpr static InstructionHandler INS_ROR_ZP0 = { 0x7E, true, "ROR - Rotate Right [Zero Page]", ShiftInstruction::shiftHandler };

	// Array of all logic instructions
	static constexpr InstructionHandler SHIFT_INSTRUCTIONS[] = {
		/** ASL Instruction Definitions */
		INS_ASL_ACC, INS_ASL_ABS, INS_ASL_ABX,

		/** ROL Instruction Definitions */
		INS_ROL_ACC, INS_ROL_ABS, INS_ROL_ABX,

		/** LSR Instruction Definitions */
		INS_LSR_ACC, INS_LSR_ABS, INS_LSR_ABX,

		/** ROR Instruction Definitions */
		INS_ROR_ACC, INS_ROR_ABS, INS_ROR_ABX,
	};
}
